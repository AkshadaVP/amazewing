...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="py-24 bg-black text-white px-8 lg:px-32">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start relative">
          {/* Sticky Text - Elegant Slide In */}
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 1, ease: "easeInOut" }}
            viewport={{ once: true }}
            className="md:sticky top-24 h-max pr-8 md:pr-16"
          >
          ...
          {/* Content Section - Display All Services */}
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
