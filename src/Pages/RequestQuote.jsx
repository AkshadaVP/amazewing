...
const RequestQuote = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white px-4 sm:px-6 py-12">
      <div className="max-w-4xl mx-auto bg-[#1a1a1a] rounded-xl shadow-lg p-6 sm:p-10">
        ...
        {/* Trip Type */}
        <div className="mb-6">
          <label className="block text-sm sm:text-base font-semibold mb-2">Trip Type</label>
        ...
        <div className="mt-10 space-y-4">
          ...
          <label className="block text-sm sm:text-base font-semibold mt-4">
            Preferred Contact Method
          </label>
          <div className="flex flex-wrap gap-4">
        ...
        <div className="mt-10 text-center">
          ...
          <p className="mt-2 text-sm italic text-gray-400">
            Our team will respond shortly with options tailored to you.
          </p>
        </div>
      </div>
    </div>
