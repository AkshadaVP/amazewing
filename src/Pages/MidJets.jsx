    ...
    <div className="bg-black text-white min-h-screen animate-fadeIn">
      ...
      <section className="space-y-10 px-4 sm:px-6 max-w-6xl mx-auto pb-16 sm:pb-20">
        {jets.map((jet, index) => (
          <div
            key={index}
            className="bg-[#111111] rounded-2xl shadow-md flex flex-col md:flex-row items-center md:justify-between gap-6 p-6 md:p-8 animate-slideInCard hover:scale-[1.015] hover:shadow-xl transition-all duration-300"
